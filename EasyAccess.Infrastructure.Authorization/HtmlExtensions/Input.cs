    ...
    public static partial class HtmlExtensions
    {
            ...
            )
        {
            if (tagParams.VerifyPermission())
            {
                ...
                return HtmlBuilder(TagType.input, tagParams.TagId, new { value = permission.ActionUrl, type = "hidden" }, null, null);
            }
            else
            {
            ...
            )
        {
            ...
            {
                Permission permission = AuthorizationManager.GetInstance().GetPermission(tagParams.PermissionId);
                Object attrs = new { value = permission.ActionUrl, type = "hidden" };
